...
//import org.kaloz.rpio.reactive.domain.api.DomainEvent
...
//  implicit val subject = PublishSubject[DomainEvent]()
//
//  val subscription = subject.subscribe(Observer[DomainEvent]((event: DomainEvent) => println(event)))
//
